...
secretkey="Y9uLapcR6q1UDRcF0Hpsyo84jscyjbdgPvtfCpqVy6c="
...
input_password = str(input("Password of the user: "))
...
try:
    ...
    while True:
        password = input_password  # Get the next password in the sequence
